...
- Lead Score Logistic Reg - PB and SK.ipynb : The python file showing coding and data analysis
- Assignment Subjective Questions - Solution (PB and SK).pdf : Some subjective questions answered
- LEAD SCORING CASE STUDY (PB and SK).pdf : Final Presentation
